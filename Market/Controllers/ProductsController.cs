...
namespace Market.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var marketDbContext = _context.Products.Include(p => p.Category).Include(p => p.Supplier);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CategoryId,Cost,Price,SupplierId,HashCode")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
